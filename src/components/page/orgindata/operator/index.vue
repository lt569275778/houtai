<template>
  <div id="users">
    ...
    <el-table :data="tableData" stripe="true" border style="width: 100%;" v-loading="loading2" element-loading-text="拼命加载中" >
      ...
      <el-table-column prop="brand" label="运营商" ></el-table-column>
      <el-table-column prop="channelName" label="渠道" ></el-table-column>
      <el-table-column fixed="right" label="操作" width="100">
        <template scope="scope">
          <router-link :to="{name: 'operatorDetail'}" tag="span">
  ...
  export default {
    ...
    methods: {
      ...
      loadData() {
        ...
        this.$axios.post(this.$api.operatorList, param).then(function(result){
        ...
        setStore(obj) {
            sessionStorage.setItem("operatorId", obj.id)
        }
    }
  }
</script>

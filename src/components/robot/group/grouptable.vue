...
<div>
    ...
    <el-table :data="data" border style="width: 100%;" @cell-dblclick="tableDoubleClick" :highlight-current-row="true" v-loading.body="tableLoading" element-loading-text="拼命加载中">
        ...
        <el-table-column prop="is_search" label="搜人">
        </el-table-column>
        <el-table-column prop="is_kick" label="踢人">
        </el-table-column>
        <el-table-column prop="is_welcome_msg" label="自动欢迎">
        </el-table-column>
        <el-table-column prop="is_auto_add" label="自动邀请">
        </el-table-column>
